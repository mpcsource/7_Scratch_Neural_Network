...
PYBIND11_MODULE(_core, m) {
    ...
    py::class_<Tensor>(m, "CTensor")
        ...
        .def("dot_add_bias_tensor", &Tensor::dot_add_bias_tensor)
        .def("sigmoid_tensor", &Tensor::sigmoid_tensor)
        .def("sigmoid_derivative_tensor", &Tensor::sigmoid_derivative_tensor)
        .def("relu_tensor", &Tensor::relu_tensor)
        .def("relu_derivative_tensor", &Tensor::relu_derivative_tensor)
